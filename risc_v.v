...
module stage_IF (
    ...
    muxy3 m3 (
        .imm_plus_pc_in (address_in),
        .pc_plus_4_in   (pc1_out),
        .alu_in         (alu_address),
        .pc_select      (pc_selector),
        .pc_in          (next_pc)
    );
    program_count pc1 (
        .clk     (clk),
...
module stage_ID (
    ...
    reg_file rf1 (
        ...
        .rd           (wb_rd),
        .write_en     (regwrite_reg),
        .write_instr  (rd_write),
        .read_instr_1 (read_data1),
        .read_instr_2 (read_data2)
    );
    imm_value imm1 (
    ...
    cntrl_unit cu1 (
        .opcode    (instruction[6:0]),
        .ALUscr    (aluscr_mux),
        .memtoreg  (memtoreg_en),
        .regwrite  (regwrite_reg_out),
        .memread   (memread_en),
    ...
    ALU_control alu_cntr1 (
        .fun3            (instruction[14:12]),
        .fun7            (instruction[30]),
        .ALU_op_in       (ALU_op_in),
        .ALU_control_out (alucntrl_alu)
    );
endmodule
...
module stage_EX (
    ...
    input  [1:0]  forwardB,
    input  [1:0]  forwardS,
    input  [31:0] exmem_alu_address,
    input  [31:0] memwb_rd_write,
    output [31:0] mux1_out,
    output [31:0] alu_address,
    output        zero_en,
    output [31:0] adder_out,
    output [1:0]  pc_selector,
    output [31:0] read_data2_out,
    output        memread_en_out,
    output        memwrite_en_out,
    ...
    muxy5 m5 (
        .read_data1_mux4   (read_data1_mux4),
        .memwb_rd_write    (memwb_rd_write),
        .exmem_alu_address (exmem_alu_address),
        .forwardA          (forwardA),
    ...
    ALU_op alu1 (
        ...
        .ALU_result     (alu_address),
        .zero           (zero_en)
    );
    adder a1 (
        .imm_val         (imm_add),
        .pc_out          (address_out),
        .imm_plus_pc_out (adder_out)
    );
    anding and1 (
        .branch    (b_en),
        .zero      (zero_en),
...
module stage_MEM (
    ...
    data_memory d1 (
        ...
        .mem_read    (memread_en),
        .mem_write   (memwrite_en),
        .mem_address (alu_address),
        .read_data   (read_data_final)
    );
endmodule
...
module reg_file(
    ...
    output [31:0] read_instr_1,
    output [31:0] read_instr_2
);
    integer i;
...
module forwarding_unit (
    ...
    input            exmem_memread_en,
    input  [4:0]     memwb_rd,
    input            memwb_regwrite,
    input            idex_aluscr_mux,
